...
/**
 * Class to hold the temperature related info from the Weather response
 *
 */
public class Temperature {
	...
	public enum HeatScale {
		 ...
		 * 
		 * @param description
		 *            long description of the temperature unit of measure.
		 * @param unit
	 ...
	 * 
	 * @param degree
	 *            numeric value of temperature degree.
	 * @param unitOfMeasure
	 *            unit of measure for the temperature.
	 */
