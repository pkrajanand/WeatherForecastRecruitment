...
/**
 * POJO representation for the configurable parameters passed in through
...
public class WeatherProviderConfiguration {
	...
	/**
	 * WeatherMap unit of measure, injected from externalised configuration. Valid
	 * values are [metric|imperial]
	 */
	 ...
	 * 
	 * @param unit
	 *            valid values are "metric", "imperial"
	 */
