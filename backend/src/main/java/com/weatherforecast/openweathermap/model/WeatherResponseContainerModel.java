...
/**
 * POJO representation for the JSON weather response from OpenWeatherMap API
 * 
 * A sample JSON response would be like {"coord":{"lon":-80.61,"lat":28.08},
 * "weather":[{"id":800,"main":"Clear","description":"sky is
 * clear","icon":"01n"}], "base":"stations",
 * "main":{"temp":12.14,"pressure":1018,"humidity":62,"temp_min":11,"temp_max":15},
 * "visibility":16093, "wind":{"speed":2.6,"deg":220},
